...
namespace Lucene.Net.Benchmarks.ByTask.Feeds
{
    ...
    public class DocMaker : IDisposable
    {
        ...
        private readonly LightWeightThreadLocal<LeftOver> leftovr = new LightWeightThreadLocal<LeftOver>();
        private LightWeightThreadLocal<DocState> docState = new LightWeightThreadLocal<DocState>();
        ...
        public virtual void SetConfig(Config config, ContentSource source)
        {
            ...
            docState = new LightWeightThreadLocal<DocState>();
