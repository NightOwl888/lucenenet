...
namespace Lucene.Net.Support.Text
{
    ...
    /// </summary>
    public class CharacterEnumeratorWrapper : CharacterIterator
    {
        ...
        public ICharacterEnumerator Enumerator => enumerator;
        ...
        /// <inheritdoc/>
        public override int EndIndex => (enumerator.Length > 0 ? 1 : 0);
