...
namespace Lucene.Net.ICU.Support
{
    ...
    {
        private static readonly RuleBasedBreakIterator SENTENCE_INSTANCE;
        private static readonly RuleBasedBreakIterator WORD_INSTANCE;
        ...
        static JdkBreakIterator()
        {
            ...
            {
                SENTENCE_INSTANCE = RuleBasedBreakIterator.GetInstanceFromCompiledRules(@is);
            }
            using (Stream @is =
                typeof(JdkBreakIterator).GetTypeInfo().Assembly.FindAndGetManifestResourceStream(typeof(JdkBreakIterator), "jdkword.brk"))
            {
                WORD_INSTANCE = RuleBasedBreakIterator.GetInstanceFromCompiledRules(@is);
            }
        }
