...
namespace Lucene.Net.Cli.Commands
{
    ...
    public class AnalysisNoriBuildDictionaryCommandTest : CommandTestCase
    {
        protected override ConfigurationBase CreateConfiguration(MockConsoleApp app)
        {
            return new AnalysisNoriBuildDictionaryCommand.Configuration(new CommandLineOptions()) { Main = (args) => app.Main(args) };
        }
