...
namespace Lucene.Net.Analysis.Core
{
    ...
    public class TestBugInSomething : BaseTokenStreamTestCase
    {
        ...
        {
            CharArraySet<string> cas = new CharArraySet<string>(TEST_VERSION_CURRENT, 3, false);
            cas.add("jjp");
            cas.add("wlmwoknt");
            cas.add("tcgyreo");
        ...
        {
            CharArraySet protWords = new CharArraySet<string>(TEST_VERSION_CURRENT, new HashSet<string>(Arrays.AsList("rrdpafa", "pupmmlu", "xlq", "dyy", "zqrxrrck", "o", "hsrlfvcha")), false);
