...
namespace Lucene.Net.Codecs
{
    ...
    public sealed class FakeDocValuesFormat : IDocValuesFormat
    {
        private readonly LuceneTestCase luceneTestCase;

        internal FakeDocValuesFormat(LuceneTestCase luceneTestCase)
        {
        ...
        public DocValuesFormat ForName(string name)
        {
            return luceneTestCase.DocValuesFormatFactory.GetDocValuesFormat(name);
        }
