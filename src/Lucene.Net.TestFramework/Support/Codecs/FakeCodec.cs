...
namespace Lucene.Net.Codecs
{
    ...
    public sealed class FakeCodec : ICodec
    {
        ...
        internal FakeCodec(LuceneTestCase luceneTestCase)
        {
        ...
        {
            return luceneTestCase.CodecFactory.GetCodec(name);
        }

        /// <summary>
        /// Returns a list of all available codec names. </summary>
        public ICollection<string> AvailableCodecs
        {
            get
            {
