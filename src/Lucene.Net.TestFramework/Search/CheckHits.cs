...
#elif FEATURE_INSTANCE_CODEC_IMPERSONATION
            QueryUtils.Check(luceneTestCase, random, query, searcher);
#else
...
#elif FEATURE_INSTANCE_CODEC_IMPERSONATION
                IndexSearcher s = QueryUtils.WrapUnderlyingReader(luceneTestCase, random, searcher, i);
#else
...
#elif FEATURE_INSTANCE_CODEC_IMPERSONATION
            QueryUtils.Check(luceneTestCase, random, query, searcher, LuceneTestCase.Rarely(random));
#else
