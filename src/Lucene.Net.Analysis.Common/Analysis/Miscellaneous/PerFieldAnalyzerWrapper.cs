...
namespace Lucene.Net.Analysis.Miscellaneous
{
    ...
    public sealed class PerFieldAnalyzerWrapper : AnalyzerWrapper
    {
        ...
        ///         <description>Use when <c>null</c> keys are required. Similar behavior as <see cref="Dictionary{TKey, TValue}"/>.</description>
        ///     </item>
        ///     <item>
        ...
        ///         <description>Use when insertion order must be preserved. <c>null</c> keys are supported.</description>
        ///     </item>
        /// </list>
