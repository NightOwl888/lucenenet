...
namespace J2N.Collections.Generic
{
    ...
    [Serializable]
#endif
    public class NullableKeyDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, IStructuralEquatable, IFormattable
    {
        ...
        /*public*/
        internal NullableKeyDictionary(IDictionary<NullableKey<TKey>, TValue> backingDictionary)
        ...
        public override bool Equals(object other)
            => Equals(other, DictionaryEqualityComparer<TKey, TValue>.Default);
        ...
        /// <summary>
        /// Returns a string representation of this dictionary based on the provided
        ...
        /// <summary>
        /// Returns a string representation of this dictionary based on <see cref="StringFormatter.CurrentCulture"/>.
        /// The string representation consists of a list of key-value mappings in the order returned by the dictionary's
        /// enumerator, enclosed in braces ("{}"). Adjacent mappings are separated by the characters ", " (comma and space).
