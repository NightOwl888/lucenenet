...
namespace Lucene.Net.Support
{
    public class HashMap<TKey, TValue> : NullableKeyDictionary<TKey, TValue>
    {
        ...
        public HashMap(DictionaryEqualityComparer<TKey, TValue> structuralEqualityComparer)
            : this(0, structuralEqualityComparer)
        { }
        ...
        public HashMap(IEqualityComparer<TKey> comparer, DictionaryEqualityComparer<TKey, TValue> structuralEqualityComparer)
            : this(0, comparer, structuralEqualityComparer)
        { }

        public HashMap(int initialCapacity)
            : this(initialCapacity, J2N.EqualityComparer<TKey>.Default)
        { }

        public HashMap(int initialCapacity, DictionaryEqualityComparer<TKey, TValue> structuralEqualityComparer)
            : this(initialCapacity, J2N.EqualityComparer<TKey>.Default, structuralEqualityComparer)
        { }

        public HashMap(int initialCapacity, IEqualityComparer<TKey> comparer)
            : base(null, new Dictionary<NullableKey<TKey>, TValue>(initialCapacity), comparer)
        { }

        public HashMap(int initialCapacity, IEqualityComparer<TKey> comparer, DictionaryEqualityComparer<TKey, TValue> structuralEqualityComparer)
            : base(null, new Dictionary<NullableKey<TKey>, TValue>(initialCapacity), comparer, structuralEqualityComparer)
        { }

        public HashMap(IEnumerable<KeyValuePair<TKey, TValue>> dictionary, IEqualityComparer<TKey> comparer)
            : base(dictionary, new Dictionary<NullableKey<TKey>, TValue>(), comparer)
        { }

        public HashMap(IEnumerable<KeyValuePair<TKey, TValue>> dictionary, IEqualityComparer<TKey> comparer, DictionaryEqualityComparer<TKey, TValue> structuralEqualityComparer)
            : base(dictionary, new Dictionary<NullableKey<TKey>, TValue>(), comparer, structuralEqualityComparer)
        { }
    }
