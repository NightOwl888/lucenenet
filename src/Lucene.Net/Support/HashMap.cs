...
namespace Lucene.Net.Support
{
    public class HashMap<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        private readonly IDictionary<NullObject<TKey>, TValue> dictionary;
        ...
        {
            this.dictionary = new Dictionary<NullObject<TKey>, TValue>(initialCapacity, new EqualityComparer(comparer));
        }

        public HashMap(IEnumerable<KeyValuePair<TKey, TValue>> dictionary, IEqualityComparer<TKey> comparer)
        //: this(new Dictionary<NullObject<TKey>, TValue>(initialCapacity, comparer), comparer)
        {
            this.dictionary = new Dictionary<NullObject<TKey>, TValue>(new EqualityComparer(comparer));
        ...
        public class EqualityComparer : IEqualityComparer<NullObject<TKey>>
        {
            ...
            public bool Equals(NullObject<TKey> x, NullObject<TKey> y)
            {
                return comparer.Equals(x, y);
            }

            public int GetHashCode(NullObject<TKey> obj)
            {
        ...
        private class KeyCollection : ICollection<TKey>
        {
            ...
            public KeyCollection(ICollection<NullObject<TKey>> collection)
            {
        ...
        {
            private readonly IEnumerator<KeyValuePair<NullObject<TKey>, TValue>> enumerator;

            public Enumerator(IEnumerator<KeyValuePair<NullObject<TKey>, TValue>> enumerator)
            {
        ...
        private static KeyValuePair<NullObject<TKey>, TValue> ConvertExternalItem(KeyValuePair<TKey, TValue> item)
        {
            return new KeyValuePair<NullObject<TKey>, TValue>(new NullObject<TKey>(item.Key), item.Value);
        }

        private static KeyValuePair<TKey, TValue> ConvertInternalItem(KeyValuePair<NullObject<TKey>, TValue> item)
        {
            return new KeyValuePair<TKey, TValue>(item.Key.Item, item.Value);
        }
    }
    ...
    public struct NullObject<T>
    {
        ...
        public override bool Equals(object other)
        {
            ...
            if (!(other is NullObject<T>))
                return false;

            var no = (NullObject<T>)other;
        ...
        public static bool operator ==(NullObject<T> left, NullObject<T> right)
        {
