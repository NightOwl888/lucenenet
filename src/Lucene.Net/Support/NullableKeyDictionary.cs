...
namespace Lucene.Net.Support
{
    ...
    /// A <see cref="NullableKey{TKey}"/> struct is used as a key for the backing dictionary.
    ...
    public class NullableKeyDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, IStructuralEquatable //, IEquatable<IDictionary<TKey, TValue>>
    {
        ...
        /*public*/ internal NullableKeyDictionary(IDictionary<NullableKey<TKey>, TValue> backingDictionary)
            : this(backingDictionary, EqualityComparer<TKey>.Default, DictionaryEqualityComparer<TKey, TValue>.Default)
        { }
        ...
        /// will be wrapped to make it support null keys.</param>
        /*public*/
        internal NullableKeyDictionary(IDictionary<NullableKey<TKey>, TValue> backingDictionary, DictionaryEqualityComparer<TKey, TValue> structuralEqualityComparer)
            : this(backingDictionary, EqualityComparer<TKey>.Default, structuralEqualityComparer)
        { }
        ...
        internal NullableKeyDictionary(
                       IDictionary<NullableKey<TKey>, TValue> backingDictionary, 
                       IEqualityComparer<TKey> comparer)
            : this(null, backingDictionary, comparer, DictionaryEqualityComparer<TKey, TValue>.Default)
        { }
        ...
        internal NullableKeyDictionary(
            IDictionary<NullableKey<TKey>, TValue> backingDictionary, 
            IEqualityComparer<TKey> comparer, 
            DictionaryEqualityComparer<TKey, TValue> structuralEqualityComparer)
            : this(null, backingDictionary, comparer, structuralEqualityComparer)
        { }
        ...
        /*protected*/
        internal NullableKeyDictionary(
            IEnumerable<KeyValuePair<TKey, TValue>> toCopy, 
            IDictionary<NullableKey<TKey>, TValue> backingDictionary, 
            IEqualityComparer<TKey> comparer)
            : this(toCopy, backingDictionary, comparer, DictionaryEqualityComparer<TKey, TValue>.Default)
        {
        }
            ...
            DictionaryEqualityComparer<TKey, TValue> structuralEqualityComparer)
        {
            ...
            this.comparer = comparer ?? J2N.EqualityComparer<TKey>.Default;
        ...
        /// <summary>
        /// Compares the specified object with this dictionary for structural equality. Returns <c>true</c> if the
        ...
        /// </summary>
        /// <param name="other">Object to be compared for structural equality with this dictionary.</param>
        ...
        public bool Equals(object other, IEqualityComparer comparer)
        {
            if (other is IDictionary<TKey, TValue> otherDictionary)
                return structuralEqualityComparer.Equals(this, otherDictionary);
            return false;
        }
        ...
        {
            return structuralEqualityComparer.GetHashCode(this);
        }
