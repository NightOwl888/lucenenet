...
namespace Lucene.Net.Index
{
    ...
    public class IndexWriter : IDisposable, ITwoPhaseCommit
    {
        ...
        // merges
        private readonly FastHashSet<SegmentCommitInfo> mergingSegments = new FastHashSet<SegmentCommitInfo>();
        ...
        private readonly FastHashSet<MergePolicy.OneMerge> runningMerges = new FastHashSet<MergePolicy.OneMerge>();
        ...
        internal class ReaderPool : IDisposable
        {
            ...
            private bool NoDups()
            {
                FastHashSet<string> seen = new FastHashSet<string>();
        ...
        {
            FastHashSet<Directory> dups = new FastHashSet<Directory>();
            ...
            try
            {
                ...
                try
                {
                    foreach (Directory dir in dirs)
                    {
                        ...
                        sis.Read(dir);
                        FastHashSet<string> dsFilesCopied = new FastHashSet<string>();
                        IDictionary<string, string> dsNames = new Dictionary<string, string>();
                        FastHashSet<string> copiedFiles = new FastHashSet<string>();
        ...
        public virtual void AddIndexes(params IndexReader[] readers)
        {
            ...
            try
            {
                ...
                info.SetFiles(new FastHashSet<string>(trackingDir.CreatedFiles));
...
#pragma warning restore 612, 618
            ...
            FastHashSet<string> segFiles = new FastHashSet<string>();
...
#pragma warning restore 612, 618
        ...
        private int MergeMiddle(MergePolicy.OneMerge merge)
        {
            ...
            try
            {
                ...
                merge.info.Info.SetFiles(new FastHashSet<string>(dirWrapper.CreatedFiles));
...
//#endif
        ...
        internal static ICollection<string> CreateCompoundFile(InfoStream infoStream, Directory directory, CheckAbort checkAbort, SegmentInfo info, IOContext context)
        {
            ...
            FastHashSet<string> siFiles = new FastHashSet<string>();
