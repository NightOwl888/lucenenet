...
namespace Lucene.Net.Index
{
    ...
    internal sealed class SegmentCoreReaders
    {
        ...
        internal readonly LightWeightThreadLocal<StoredFieldsReader> fieldsReaderLocal;
        internal readonly LightWeightThreadLocal<TermVectorsReader> termVectorsLocal;
        internal readonly LightWeightThreadLocal<IDictionary<string, object>> normsLocal = new LightWeightThreadLocal<IDictionary<string, object>>(() => new Dictionary<string, object>());
        ...
        {
            fieldsReaderLocal = new LightWeightThreadLocal<StoredFieldsReader>(() => 
                (StoredFieldsReader)fieldsReaderOrig.Clone());
            termVectorsLocal = new LightWeightThreadLocal<TermVectorsReader>(() => 
