...
namespace Lucene.Net.Util
{
    ...
    public sealed class BroadWord
    {
        ...
        /// <summary>
        /// Naive implementation of <see cref="Select(long, int)"/>, using <see cref="J2N.Numerics.BitOperationExtensions.LeadingZeroCount(long)"/> repetitively.
