...
#pragma warning restore 612, 618
        ...
        protected class FSIndexOutput : BufferedIndexOutput
        {
            ...
            public override void Flush()
            {
                ...
                // persist them on disk. We need to explicitly call FileStream.Flush(true) to move them there.
            ...
            protected override void Dispose(bool disposing)
            {
                ...
                { 
                    ...
                    if (isOpen)
                    {
                        ...
                        try
                        {
                            base.Dispose(disposing); // LUCENENET NOTE: This handles Flush() for us automatically
                        }
